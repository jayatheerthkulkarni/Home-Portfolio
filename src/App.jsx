...
const nav_json = [
	...
	{ label: "Blogs", href: "https://blog.jayatheerth.com" },
];
...
const blog_json = [
	{
		...
		img: "./mailinglist.png",
		link: "https://blog.jayatheerth.com/how-does-a-mailing-list-work",
		site: "https://blog.jayatheerth.com",
	},
	{
		title: "Building Reliable Backend Systems in Go",
		desc: "A practical guide to designing maintainable, observable Go backends covering interfaces, dependency injection, error handling, and testing patterns.",
		img: "./go-backend.png",
		link: "https://blog.jayatheerth.com/building-reliable-backend-systems-in-go",
		site: "https://blog.jayatheerth.com",
	},
	{
		...
		img: "./gitworks.png",
		link: "https://blog.jayatheerth.com/why-git-works-the-way-it-does",
		site: "https://blog.jayatheerth.com",
	},
	{
		title: "Modern Concurrency Models Explained",
		desc: "Threads, goroutines, event loops, and actors what they solve, when to use them, and why choosing the right model matters for high-performance systems.",
		img: "./concurrency.png",
		link: "https://blog.jayatheerth.com/modern-concurrency-models-explained",
		site: "https://blog.jayatheerth.com",
	},
];
...
export default function App() {
	...
	const scrollLeft = () => {
		...
		const amount = Math.floor(carouselRef.current.clientWidth * 0.7);
		...
		>
			<div className="max-w-4xl mx-auto px-6 pb-24">
				...
				<main className="space-y-8">
					<div className="space-y-2">
						...
						>
							Some people online call me Gink. I’ve stopped
					...
					<div className="space-y-6 max-w-2xl">
						...
						>
							People say first impressions matter, so here’s mine.
						</p>
						...
						>
							...
							and fix tools everyone quietly complains about. I’ve
							contributed code to{" "}
							<span
								className={`font-semibold ${darkMode ? "text-white" : "text-neutral-900"}`}
							>
							...
							which is fun, humbling, and slightly terrifying.
							Currently leading the Open Source Foundation at
							GCET.
						</p>
					</div>
					...
					<button
						onClick={() =>
							(window.location.href =
								"https://blog.jayatheerth.com/a-new-language/")
						}
					...
					<section className="mt-20 space-y-10">
						<h2
							className={`text-3xl ${darkMode ? "text-white" : "text-neutral-900"}`}
						>
							Things I Build So You Don't Have To
						</h2>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-10 place-items-center">
							...
							<div className="relative group rounded-xl overflow-hidden cursor-pointer max-w-sm w-full">
								...
								>
									<h3 className="text-xl font-semibold">
										Auth as a library but industrial grade
									</h3>
									<p className="mt-2 text-sm opacity-90 max-w-md">
										A Go authentication library that
										eliminates boilerplate.
									</p>
									<button
										onClick={() =>
											(window.location.href =
												"https://jayatheerth.com/project/auth")
										}
							...
							<div className="relative group rounded-xl overflow-hidden cursor-pointer max-w-sm w-full">
								...
								>
									<h3 className="text-xl font-semibold">
										Project Forum but smarter
									</h3>
									<p className="mt-2 text-sm opacity-90 max-w-md">
										Matches students to projects like a
										productive Tinder swipe.
									</p>
									<button
										onClick={() =>
											(window.location.href =
												"https://jayatheerth.com/project/project-forum")
										}
										className="cursor-pointer mt-4 self-start rounded-full px-5 py-2 text-sm font-medium shadow-md transition-all duration-300 bg-[#0B1736] text-white hover:bg-[#0c1d48]"
									>
										View Project
					...
					<section className="mt-20 pb-10">
						...
						>
							Skills That Should Pay the Bills
						</h2>
			...
			>
				<div className="max-w-4xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-3 gap-10">
					...
					<div className="space-y-3">
						...
						<ul className="space-y-2 text-sm">
							...
							<li>
								<a
									href="https://github.com/jayatheerthkulkarni/Inventory-Management-System"
									target="_blank"
									rel="noreferrer"
									className="hover:opacity-90"
								>
				...
				<div className="text-center text-sm opacity-70 mt-10">
					© {new Date().getFullYear()} Jayatheerth. All rights
					reserved.
				</div>
			</footer>
